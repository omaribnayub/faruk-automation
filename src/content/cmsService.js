...
import { CMS_STORAGE_KEY, getContent, resetContent, saveContent } from "./cmsStorage";
...
export async function getSiteContent() {
  ...
  if (!snap.exists()) {
    await setDoc(ref, { content: defaultContent, updatedAt: serverTimestamp() });
